...
public class RelatedProductShoppingAdapter extends RecyclerView.Adapter<RelatedProductShoppingAdapter.MyViewHolder> {
    ...
    public RelatedProductShoppingAdapter(Activity mContext, List<DashboardProductListData> transactionsList, int layout) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(layout, null);
 ...
 */
    ...
    public void usingCustomIcons(MyViewHolder holder) {
        ...
        holder.vectorAddToCard.setLikeDrawable(new BitmapDrawable(mContext.getResources(), new IconicsDrawable(mContext, CommunityMaterial.Icon.cmd_cart).colorRes(R.color.greycon).sizeDp(40).toBitmap()));
                ...
                public void onSucess(final Object response) {
                    ...
                    if (data.getStatuscode() == 1) {
                        ...
                        if (mContext instanceof MainCategoryDetailShoppingActivity) {
                            ((MainCategoryDetailShoppingActivity) mContext).cartUpdate(mCartItemCount);
                        } else if (mContext instanceof ItemDetailsShoppingActivity) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public LinearLayout llMainCat, likeOverView;
        ...
        public MyViewHolder(View view) {
            ...
            vectorAddToCard = view.findViewById(R.id.vector_cart_icon);
            vectorLike = view.findViewById(R.id.vector_like);
