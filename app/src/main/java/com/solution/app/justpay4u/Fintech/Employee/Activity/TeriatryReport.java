...
import com.solution.app.justpay4u.Fintech.Employee.Adapter.TeriatryReportAdapter;
import com.solution.app.justpay4u.Fintech.Employee.Api.Object.GetTeriatryReport;
...
public class TeriatryReport extends AppCompatActivity {
        ...
        new Handler(Looper.getMainLooper()).post(() -> {
            ...
            new Handler(Looper.getMainLooper()).post(() -> {
                ...
                searchDate.setOnClickListener(v -> {
                    ...
                    DatePickerDialog mDatePickerDialog = new DatePickerDialog(TeriatryReport.this, date, myCalendar
    ...
    public void HitApi() {
        if (ApiFintechUtilMethods.INSTANCE.isNetworkAvialable(this)) {
            ...
            ApiFintechUtilMethods.INSTANCE.GetTertiaryReportEmp(this, searchDate.getText().toString(), 0, mLoginDataResponse, deviceId,
                    deviceSerialNum, loader, new ApiFintechUtilMethods.ApiResponseCallBack() {
                        @Override
                        public void onSucess(Object object) {
                            GetTeriatryReportResponse mGetTeriatryReportResponse = (GetTeriatryReportResponse) object;
                            dataParse(mGetTeriatryReportResponse);
                        }
    ...
    public void dataParse(GetTeriatryReportResponse mRechargeReportResponse) {

        ArrayList<GetTeriatryReport> transactionsObjects = mRechargeReportResponse.getData();

        if (transactionsObjects.size() > 0) {
            noDataView.setVisibility(View.GONE);
            noNetworkView.setVisibility(View.GONE);
            recycler_view.setVisibility(View.VISIBLE);
            mAdapter = new TeriatryReportAdapter(transactionsObjects, this);
