...
import com.solution.app.justpay4u.Fintech.Employee.Adapter.PstReportAdapter;
...
public class PstReport extends AppCompatActivity {

    RecyclerView recycler_view;
    PstReportAdapter mAdapter;
    ImageView search;
    TextView searchDate;
    EditText search_all;
    CustomLoader loader;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Handler(Looper.getMainLooper()).post(() -> {
            setContentView(R.layout.activity_pst_report);
            ...
            new Handler(Looper.getMainLooper()).post(() -> {
                ...
                todatay = sdf.format(Calendar.getInstance().getTime());
    ...
    public void HitApi() {
        if (ApiFintechUtilMethods.INSTANCE.isNetworkAvialable(this)) {
            ...
            ApiFintechUtilMethods.INSTANCE.GetPSTReportEmp(this, searchDate.getText().toString(), 0, mLoginDataResponse, deviceId,
                    deviceSerialNum, loader, new ApiFintechUtilMethods.ApiResponseCallBack() {
                        @Override
                        public void onSucess(Object object) {
                            GetPstReportResponse mGetPstReportResponse = (GetPstReportResponse) object;
                            dataParse(mGetPstReportResponse);
                        }
    ...
    public void dataParse(GetPstReportResponse mRechargeReportResponse) {

        ArrayList<GetPstReport> transactionsObjects = mRechargeReportResponse.getData();

        if (transactionsObjects.size() > 0) {
            noDataView.setVisibility(View.GONE);
            noNetworkView.setVisibility(View.GONE);
            recycler_view.setVisibility(View.VISIBLE);
            mAdapter = new PstReportAdapter(transactionsObjects, this);
