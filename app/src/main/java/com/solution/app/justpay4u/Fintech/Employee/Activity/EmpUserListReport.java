...
import com.solution.app.justpay4u.Fintech.Employee.Adapter.EmpUserAdapter;
...
public class EmpUserListReport extends AppCompatActivity {
    ...
    void findViews() {
        ...
        mAdapter = new EmpUserAdapter(transactionsObjects, this);
    ...
    private void HitApi(boolean isLoaderShow) {
        if (ApiFintechUtilMethods.INSTANCE.isNetworkAvialable(this)) {
            ...
            ApiFintechUtilMethods.INSTANCE.GetEmployeesUser(this, filterEnterCriteria, filterChooseCriteriaId, filterRoleId, false, true, 0,
                    filterTopValue,
                    mLoginDataResponse, deviceId, deviceSerialNum, loader, new ApiFintechUtilMethods.ApiResponseCallBack() {
                        ...
                        public void onSucess(Object object) {
                            ...
                            GetEmployeesUserResponse mGetEmployeesUserResponse = (GetEmployeesUserResponse) object;
                            if (mGetEmployeesUserResponse != null && mGetEmployeesUserResponse.getData() != null && mGetEmployeesUserResponse.getData().size() > 0) {
                                transactionsObjects.addAll(mGetEmployeesUserResponse.getData());
                            ...
                            mAdapter = new EmpUserAdapter(transactionsObjects, EmpUserListReport.this);
                            recycler_view.setAdapter(mAdapter);
                        }
