...
public class ChannelReportActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Handler(Looper.getMainLooper()).post(() -> {
            ...
            new Handler(Looper.getMainLooper()).post(() -> {
                ...
                intentAreaId = getIntent().getIntExtra("AREA_ID", 0);
    ...
    void findViews() {
        ...
        fosCollectionReportAdapter = new FOSChannelReportAdapter(filterFromDate, filterToDate, transactionsObjects, loader,
                loginPrefResponse, this, deviceId, deviceSerialNum, mAppPreferences, () -> HitLastApi());
    ...
    public void HitLastApi() {
        if (ApiFintechUtilMethods.INSTANCE.isNetworkAvialable(this)) {
            ...
            ApiFintechUtilMethods.INSTANCE.AccStmtAndCollFilterFosClick(this, filterTopValue + "", filterFromDate,
                    filterToDate, "2", loader, loginPrefResponse, deviceId, deviceSerialNum
                    , intentAreaId, new ApiFintechUtilMethods.ApiResponseCallBack() {
                        @Override
