...
public class AEPSMiniStatementRPAdapter extends RecyclerView.Adapter<AEPSMiniStatementRPAdapter.MyViewHolder> {
    ...
    @Override
    public AEPSMiniStatementRPAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_mini_statement, parent, false);

        return new AEPSMiniStatementRPAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final AEPSMiniStatementRPAdapter.MyViewHolder holder, int position) {
