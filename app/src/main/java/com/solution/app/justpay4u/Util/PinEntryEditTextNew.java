...
public class PinEntryEditTextNew extends AppCompatEditText {
   ...
   /* @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    ...
    public void setMaxLength(int mMaxLength) {
        ...
        mInputFilters[0] = new InputFilter.LengthFilter(mMaxLength);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float radius = 20 * getResources().getDisplayMetrics().density; // Convert dp to pixels


        for (int i = 0; i < mNumChars; i++) {
            updateColorForLines(i == textLength);
            // Draw rectangles instead of lines
            RectF rect = new RectF(startX, bottom - mCharSize, startX + mCharSize, bottom);
            canvas.drawRoundRect(rect, radius, radius, mLinesPaint);

//            canvas.drawRoundRect(rect, 20f, 20f, mLinesPaint);
//            canvas.drawRect(startX, bottom - mCharSize, startX + mCharSize, bottom, mLinesPaint);
