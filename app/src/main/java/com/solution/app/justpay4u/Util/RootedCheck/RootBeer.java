...
public class RootBeer {
    ...
    public static boolean detectTestKeys() {
        ...
        return (buildTags != null) && (buildTags.contains("test-keys")) || (buildTags != null) && (buildTags.contains("dev-keys")) || buildFinger.contains("genric.*test-keys") || product.contains("generic") || product.contains("sdk") || hardware.contains("goldfish") || display.contains(".*test-keys");
    }
    ...
    public boolean isRooted() {
        ...
        return detectRootManagementApps() || detectPotentiallyDangerousApps() || checkForBinary("su")
                ...
                || detectTestKeys() || checkSuExists() || checkForApk() || checkBusyBoxApplication() /*|| checkForRootNative()*/;
    }
    ...
    public boolean checkForApk() {
        boolean result = false;
        try {
            File file = new File("/system/app/Superuser.apk");
            if (file.exists()) {
                QLog.v(file + " apk detected!");
                result = true;
            }
        } catch (Throwable e1) {
            //Ignore
    ...
    public boolean checkBusyBoxApplication() {
        boolean result = false;
        ...
        try {
            ...
            QLog.v(packageName + " packageName detected!");
            result = true;
