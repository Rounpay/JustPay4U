...
public class FOSAccSmtReportAdapter extends RecyclerView.Adapter<FOSAccSmtReportAdapter.MyViewHolder> implements Filterable {
    ...
    private double calculatedTransferAmtVal;

    public FOSAccSmtReportAdapter(ArrayList<AscReport> transactionsList, Context mContext, CustomLoader loader,
    ...
    @Override
    public void onBindViewHolder(final FOSAccSmtReportAdapter.MyViewHolder holder, int position) {
        ...
        holder.fundTransferView.setOnClickListener(v -> {
            if (isFlatCommission) {
                ApiFintechUtilMethods.INSTANCE.GeUserCommissionRate(mContext, operator.getUserID(), loader, deviceId, deviceSerialNum, mLoginDataResponse, object -> {
