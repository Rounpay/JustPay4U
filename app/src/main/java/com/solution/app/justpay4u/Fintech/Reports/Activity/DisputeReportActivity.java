...
public class DisputeReportActivity extends AppCompatActivity {
    ...
    void findViews() {
        ...
        mAdapter = new DisputeReportAdapter(transactionsObjects, DisputeReportActivity.this);
    ...
    private void HitApi() {
        if (ApiFintechUtilMethods.INSTANCE.isNetworkAvialable(this)) {
            ...
            ApiFintechUtilMethods.INSTANCE.RefundLog(this, filterTopValue, filterChooseCriteriaId, filterChooseCriteria,
                    filterStatusId, filterFromDate, filterToDate, filteDateTypeId, filterEnterCriteria, loader, mLoginDataResponse,
