...
public class AppGetAMResponse implements Parcelable {
    ...
    protected AppGetAMResponse(Parcel in) {
        areaMaster = in.createTypedArrayList(AreaMaster.CREATOR);
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeTypedList(areaMaster);
    ...
    public static final Creator<AppGetAMResponse> CREATOR = new Creator<AppGetAMResponse>() {
        @Override
        public AppGetAMResponse createFromParcel(Parcel in) {
            return new AppGetAMResponse(in);
        }

        @Override
        public AppGetAMResponse[] newArray(int size) {
            return new AppGetAMResponse[size];
        }
    };
