...
import com.solution.app.justpay4u.Networking.Adapter.TotalBusinessNetworkingAdapter;
...
public class TotalBuisnessNetworkingActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Handler(Looper.getMainLooper()).post(() -> {
            setContentView(R.layout.activity_networking_total_buisness);
            ...
            if (filterLeg!=null &&(filterLeg.equalsIgnoreCase("L") || filterLeg.equalsIgnoreCase("R"))) {
                setTitle(filterLeg.equalsIgnoreCase("L")?"Left Business":"Right Business");
    ...
    void findViews() {
        ...
        leftBv = findViewById(R.id.leftBv);
        rightBv = findViewById(R.id.rightBv);
        recycler_view = findViewById(R.id.recycler_view);
        mAdapter = new TotalBusinessNetworkingAdapter(transactionsObjects, TotalBuisnessNetworkingActivity.this);
        ...
        if (ApiNetworkingUtilMethods.INSTANCE.isVpnConnected(this)) {
            ...
            if (ApiFintechUtilMethods.INSTANCE.isNetworkAvialable(this)) {
                ...
                try {
                    ...
                    Call<MemberListResponse> call = git.BinaryBusiness(new MemberListRequest(new BasicRequest(loginPrefResponse.getData().getUserID(),
                            ...
                            loginPrefResponse.getData().getSession()), new MemberListRequest(filterLeg, filterBuisnessTypeId + "",
                                ...
                                if (response.isSuccessful()) {
                                    if (response.body() != null) {
                                        if (response.body().getStatuscode() == 1) {
                                            ...
                                            leftBv.setText(Utility.INSTANCE.formatedAmountWithOutRupees(response.body().getLeftBusiness() + ""));
                                            rightBv.setText(Utility.INSTANCE.formatedAmountWithOutRupees(response.body().getRightBusiness() + ""));
