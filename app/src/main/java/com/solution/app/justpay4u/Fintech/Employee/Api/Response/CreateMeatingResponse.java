...
import com.solution.app.justpay4u.Fintech.Employee.Api.Object.CreateMeatingData;


public class CreateMeatingResponse {
    @SerializedName("data")
    @Expose
    public CreateMeatingData data;
    ...
    public CreateMeatingData getData() {
        return data;
    }
