...
public class ChangeQuantityRequest {
    ...
    public ChangeQuantityRequest(int itemID, int quantity, String userID, String loginTypeID, String appid, String imei, String regKey, String version, String serialNo, String sessionID, String session) {
        this.itemID = itemID;
