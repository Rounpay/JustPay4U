...
public class StatesCitiesResponse {
    @SerializedName(value = "states", alternate = "cities")
    @Expose
    public List<StatesCities> statesCities = null;
    ...
    public List<StatesCities> getStatesCities() {
        return statesCities;
    }
