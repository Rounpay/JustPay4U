...
import com.solution.app.justpay4u.Fintech.Employee.Api.Object.UserByMobileData;


public class UserByMobileResponse {
    @SerializedName("data")
    @Expose
    public UserByMobileData data;
    ...
    public UserByMobileData getData() {
        return data;
    }
