...
public class RechargeReportAdapter extends RecyclerView.Adapter<RechargeReportAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final RechargeReportAdapter.MyViewHolder holder, int position) {
        ...
        holder.balance.setText("\u20B9 " + Utility.INSTANCE.formatedAmountReplaceLastZero(Double.parseDouble(operator.getBalance()+"")));
        holder.lastbalance.setText("\u20B9 " + Utility.INSTANCE.formatedAmountReplaceLastZero(Double.parseDouble(operator.getLastBalance() + "")));
        holder.amount.setText("\u20B9 " + Utility.INSTANCE.formatedAmountReplaceLastZero(Double.parseDouble(operator.getRequestedAmount() + "")));
        holder.debit.setText("\u20B9 " + Utility.INSTANCE.formatedAmountReplaceLastZero(Double.parseDouble(operator.getAmount() + "")));
        holder.comm.setText("\u20B9 " + Utility.INSTANCE.formatedAmountReplaceLastZero(Double.parseDouble(operator.getCommission() + "")));
        ...
        if (operator.getType_().equalsIgnoreCase("SUCCESS")) {
            status = "Success";
            holder.liveIdLabel.setText("Provider Ref Id");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public AppCompatTextView lastbalance, bank;
