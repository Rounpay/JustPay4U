...
public class CitiesRequest {
    ...
    public CitiesRequest(int stateID, String userID, String loginTypeID, String appid, String imei, String regKey, String version, String serialNo, String sessionID, String session) {
