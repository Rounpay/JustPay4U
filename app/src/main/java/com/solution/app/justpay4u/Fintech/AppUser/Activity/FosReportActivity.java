...
import com.solution.app.justpay4u.Fintech.AppUser.Adapter.FOSChannelReportAdapter;
...
public class FosReportActivity extends AppCompatActivity {
    ...
    TextView errorMsg, balanceTab, uBalanceTab;
    int arId;
    ...
    void findViews() {
        ...
        fosCollectionReportAdapter = new FOSChannelReportAdapter(filterFromDate, filterToDate, transactionsObjects, loader, loginPrefResponse, this,
                deviceId, deviceSerialNum, mAppPreferences, () -> HitLastApi());
    ...
    public void HitLastApi() {
        if (ApiFintechUtilMethods.INSTANCE.isNetworkAvialable(this)) {
            ...
            ApiFintechUtilMethods.INSTANCE.AccStmtAndCollFilterFosClick(this, filterTopValue + "", filterFromDate, filterToDate,
                    "1", loader, loginPrefResponse, deviceId, deviceSerialNum
                    , arId, new ApiFintechUtilMethods.ApiResponseCallBack() {
                        @Override
