...
public class SlabCommtObject {
    ...
    public void setSlabDetailID(String slabDetailID) {
        this.slabDetailID = slabDetailID;
    }
    ...
    public void setAccountRemak(String accountRemak) {
        this.accountRemak = accountRemak;
    }
}
