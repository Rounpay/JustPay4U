...
public class TeriatryReportAdapter extends RecyclerView.Adapter<TeriatryReportAdapter.MyViewHolder> {


    private ArrayList<GetTeriatryReport> rechargeStatus;
    private ArrayList<GetTeriatryReport> transactionsList;
    private Activity mContext;
    private String charText;


    public TeriatryReportAdapter(ArrayList<GetTeriatryReport> transactionsList, Activity mContext) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_teriatry_report, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final GetTeriatryReport operator = transactionsList.get(position);
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (GetTeriatryReport wp : rechargeStatus) {
