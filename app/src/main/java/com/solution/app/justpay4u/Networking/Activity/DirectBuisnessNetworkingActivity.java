...
import com.solution.app.justpay4u.Networking.Adapter.DirectBuisnessNetworkingAdapter;
...
public class DirectBuisnessNetworkingActivity extends AppCompatActivity {
    ...
    LinearLayout totalSumLabelLayout;
    ...
    void findViews() {
        ...
        totalSumLabelLayout = findViewById(R.id.totalSumLabelLayout);
        errorMsg = findViewById(R.id.errorMsg);

        recycler_view = findViewById(R.id.recycler_view);
        mAdapter = new DirectBuisnessNetworkingAdapter(transactionsObjects, DirectBuisnessNetworkingActivity.this);
        ...
        if (ApiNetworkingUtilMethods.INSTANCE.isVpnConnected(this)) {
            ...
            if (ApiFintechUtilMethods.INSTANCE.isNetworkAvialable(this)) {
                ...
                try {
                    ...
                    Call<MemberListResponse> call = git.DirectBusiness(new MemberListRequest(new BasicRequest(loginPrefResponse.getData().getUserID(),
                            ...
                            loginPrefResponse.getData().getSession()), new MemberListRequest(0, "All",
                            filterBuisnessTypeId + "",
...
*/
    ...
    public void dataParse(MemberListResponse transactions) {
        ...
        if (transactions != null && transactions.getData() != null && transactions.getData().size() > 0) {
            ...
            totalSumLabelLayout.setVisibility(View.VISIBLE);
            ...
            recycler_view.setVisibility(View.GONE);
            totalSumLabelLayout.setVisibility(View.GONE);
        }
    }
